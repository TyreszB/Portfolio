...
export default function App() {
    ...
    function Nav() {
        ...
        return (
            <div className="sticky top-0 w-full h-[80px] z-10 flex justify-between px-5">
                ...
                {/*mobile nav*/}
                <ul className={!isOpen ? "hidden" : "fixed flex flex-col justify-center items-center w-full h-screen text-slate-100 font-league z-[1000]"}>
                ...
                <ul className="flex text-slate-100 font-league invisible md:visible items-center">
                    <li>
                        <Link to="tools" smooth={true} duration={500} offset={-250}>
                            <button
                                className='transition ease-in-out duration-300 hover:bg-purple-300 hover:-translate-y-1 hover:scale-110 p-2 m-2 bg-[#62336b] rounded-full'>
                                TOOLS
                            </button>
                        </Link>
    ...
    function MainLogo() {
        return (
            <div name='home' className="md:my-[100px] md:flex justify-around md:h-screen">
                <div className='mx-auto'>
                    <img src={Logo} alt='Logo' className="rounded-full w-auto mx-auto border-2"/>
                </div>
        ...
        return (
            <div className='max-w-[400px] md:max-w-[1000px] mx-auto flex flex-col justify-center'>
                <p className='font-league text-4xl'>
                    A versatile full-stack developer who brings ideas to life through elegant code. With a passion for
                    crafting seamless user experiences and a knack for both front-end and back-end technologies,
                    thriving in creating innovative digital solutions.
                </p>
            </div>
        )
    }
    ...
    function Work() {
        ...
        return (
            <div className='flex flex-col md:h-screen'>
                <h1 name='work'
                    className='invisible md:visible text-center text-6xl font-league font-bold md: mb-10'>Work</h1>
                        ...
                        <a href="https://fieldtriplab.com" target="_blank">
                            <img
                                ...
                                className={`rounded-3xl mx-auto shadow-lg shadow-cyan-500/50 hover:scale-110 duration-500 md:h-full md:w-full ${
                                    selectedImage === 0 ? 'opacity-100 hover:opacity-100' : 'opacity-50 hover:opacity-100'
                                }`}
                            />
                        </a>
                    </div>
                    <div className='mx-auto h-4/5 w-4/5 mb-[100px] md:w-[500px] md:h-auto md:ms-4'>
                        <a href="https://fieldtriplab.com" target="_blank">
                            <img
                                ...
                                className={`rounded-3xl mx-auto shadow-lg shadow-cyan-500/50 hover:scale-110 duration-500 md:h-full md:w-full ${
                                    selectedImage === 1 ? 'opacity-100 hover:opacity-100' : 'opacity-50 hover:opacity-100'
                                }`}
                            />
                        </a>
                    </div>
            ...
            <div className='md:h-screen' name='tools'>
                ...
                <div className='columns-3 md:flex max-w-[1000px] mx-auto '>
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg"
                         alt="html5 logo" className='h-[100px] w-[100px] mx-auto my-12 hover:scale-110 duration-500'/>
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg"
                         alt="spring logo" className='h-[100px] w-[100px] mx-auto my-12 hover:scale-110 duration-500'/>
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg"
                         alt="bootstrap logo"
                         className='h-[100px] w-[100px] mx-auto my-12 hover:scale-110 duration-500'/>
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg"
                         alt="mysql logo" className='h-[100px] w-[100px] mx-auto my-12 hover:scale-110 duration-500'/>
                </div>
                <About/>
            </div>
    ...
    function Contact() {
        return (
            <div name='contact'
                ...
                <form action="https://getform.io/f/bac73a8f-e612-4c24-8043-e2bcbcabd2db" method="POST"
                      className='flex flex-col max-w[600px] w-full '>
                    <div className="pb-8">
                        <p className='text-4xl font-bold inline font-league border-b-4 border-[#62336b]'>Contact</p>
                        <p className='py-4'>Submit the form below or shoot me an email - Tyreszbrash@gmail.com </p>
                    </div>
                    <input className=' rounded p-2 bg-slate-100 text-slate-600' type="text" placeholder='Name'
                           name='name'/>
    ...
    function Footer() {
        return (
            <Link to="home" smooth={true} duration={500} offset={-150}>
                <button
                    className='sticky bottom-0 rounded transition ease-in-out duration-300 hover:bg-purple-300 hover:-translate-y-1 hover:scale-110 p-3 my-8 bg-[#62336b] '>
                    TOP
                </button>
            </Link>
        )
